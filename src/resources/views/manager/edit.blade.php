        ...
        <form class="form" action="update" method="post" enctype="multipart/form-data">
            ...
            <div class="form__group">
                <div class="form__item">
                    ...
                    <input class="form__input" type="text" name="shop_name" value="{{ old('shop_name', $shop->shop_name) }}"></input>
                </div>
                ...
                <div class="form__item">
                    ...
                    <select class="form__input" name="shop_area_id">
                        ...
                        <option value="{{ $shop_area->id }}" {{ old('shop_area_id', $shop->shop_area_id) == $shop_area->id ? 'selected' : '' }}>{{ $shop_area->shop_area }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="error-message error-message--margin">
                ...
                <div class="form__item">
                    ...
                    <select class="form__input" name="shop_genre_id">
                        ...
                        <option value="{{$shop_genre->id}}" {{ old('shop_genre_id', $shop->shop_genre_id) == $shop_genre->id ? 'selected' : '' }}>{{$shop_genre->shop_genre}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="error-message error-message--margin">
                ...
                <div class="form__item">
                    ...
                    <textarea class="form__textarea" name="shop_description" rows="10" columns="30">{{ old('shop_description', $shop->shop_description) }}</textarea>
                </div>
                <div class="error-message error-message--margin">
