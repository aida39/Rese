                ...
                <ul>
                    <ul class="menu__nav__list">
                        ...
                        <li class="menu__nav__item">
                            <a class="menu__nav__link" href="/manager/index">Home</a>
                        </li>
                        <li class="menu__nav__item">
                            <a class="menu__nav__link" href="/manager/create">Shop Create</a>
                        </li>
                        <li class="menu__nav__item">
                            <a class="menu__nav__link" href="/manager/logout">Logout</a>
                        </li>
                        @else
                        <li class="menu__nav__item">
                            <a class="menu__nav__link" href="/manager/login">Login</a>
                        </li>
                        @endif
                    </ul>
                </ul>
